...
public class Basics {
	...
	private void populate(IFile root, int id) throws IOException {
	...
	private void read(IFile root, int id) throws IOException {
	...
	@Test
	public void simpleHierarchical() throws IOException {
	...
	@Test
	public void scale() throws IOException, NoSuchAlgorithmException {
		
		IFile file1 = new MemoryFile();
		
//		new File("/Volumes/ramdisk/container.dat").delete();
//		IFile file1 = new RealFile("/Volumes/ramdisk/container.dat");
		
		ByteArrayOutputStream bout = new ByteArrayOutputStream();
		DataOutputStream tasks = new DataOutputStream(bout);
		
		RandomAccessBuffer file1Buffer = file1.openAsBuffer();
		XContainer<Integer> container = new XContainer<Integer>(file1Buffer, Serializers.integer);
		...
		while(file1Buffer.length() < 5 * 1024 * 1024) {
		...
		container = new XContainer<Integer>(file1.openAsBuffer(), Serializers.integer);
